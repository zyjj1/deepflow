...
type DataLinkLayer struct {
	...
	VLAN    uint16 `json:"vlan,omitempty" category:"tag" sub:"data_link_layer"`
}
...
type NetworkLayer struct {
	...
	Protocol     uint8  `json:"protocol" category:"tag"  sub:"network_layer" translate:"protocol" tranlate:"tunnel_tier"`
	TunnelTier   uint8  `json:"tunnel_tier,omitempty" category:"tag" sub:"tunnel_info" tranlate:"tunnel_type"`
	TunnelType   uint16 `json:"tunnel_type,omitempty" category:"tag" sub:"tunnel_info"`
	TunnelTxID   uint32 `json:"tunnel_tx_id,omitempty" category:"tag" sub:"tunnel_info"`
	TunnelRxID   uint32 `json:"tunnel_rx_id,omitempty" category:"tag" sub:"tunnel_info"`
	TunnelTxIP40 uint32 `json:"tunnel_tx_ip4_0,omitempty" category:"tag" sub:"tunnel_info" to_string:"IPv4String"`
	TunnelTxIP41 uint32 `json:"tunnel_tx_ip4_1,omitempty" category:"tag" sub:"tunnel_info" to_string:"IPv4String"`
	TunnelRxIP40 uint32 `json:"tunnel_rx_ip4_0,omitempty" category:"tag" sub:"tunnel_info" to_string:"IPv4String"`
	TunnelRxIP41 uint32 `json:"tunnel_rx_ip4_1,omitempty" category:"tag" sub:"tunnel_info" to_string:"IPv4String"`
	TunnelTxIP60 net.IP `json:"tunnel_tx_ip6_0,omitempty" category:"tag" sub:"tunnel_info" to_string:"IPv6String"`
	TunnelTxIP61 net.IP `json:"tunnel_tx_ip6_1,omitempty" category:"tag" sub:"tunnel_info" to_string:"IPv6String"`
	TunnelRxIP60 net.IP `json:"tunnel_rx_ip6_0,omitempty" category:"tag" sub:"tunnel_info" to_string:"IPv6String"`
	TunnelRxIP61 net.IP `json:"tunnel_rx_ip6_1,omitempty" category:"tag" sub:"tunnel_info" to_string:"IPv6String"`
	TunnelIsIPv4 bool   `json:"tunnel_is_ipv4" category:"tag" sub:"tunnel_info"`
	TunnelTxMac0 uint32 `json:"tunnel_tx_mac_0,omitempty" category:"tag" sub:"tunnel_info"`
	TunnelTxMac1 uint32 `json:"tunnel_tx_mac_1,omitempty" category:"tag" sub:"tunnel_info"`
	TunnelRxMac0 uint32 `json:"tunnel_rx_mac_0,omitempty" category:"tag" sub:"tunnel_info"`
	TunnelRxMac1 uint32 `json:"tunnel_rx_mac_1,omitempty" category:"tag" sub:"tunnel_info"`
}
...
type TransportLayer struct {
	...
	TCPFlagsBit0     uint16 `json:"tcp_flags_bit_0,omitempty" category:"tag" sub:"transport_layer"`
	TCPFlagsBit1     uint16 `json:"tcp_flags_bit_1,omitempty" category:"tag" sub:"transport_layer"`
...
type KnowledgeGraph struct {
	RegionID0     uint16 `json:"region_id_0,omitempty" category:"tag" sub:"universal_tag"`
	...
	PodGroupType0 uint8  `json:"pod_group_type_0" category:"tag" sub:"universal_tag"` // no need to store
	PodGroupType1 uint8  `json:"pod_group_type_1" category:"tag" sub:"universal_tag"` // no need to store
	...
	AutoInstanceType0 uint8  `json:"auto_instance_type_0" category:"tag" sub:"universal_tag"`
	AutoServiceID0    uint32 `json:"auto_service_id_0" category:"tag" sub:"universal_tag"`
	AutoServiceType0  uint8  `json:"auto_service_type_0" category:"tag" sub:"universal_tag"`

	AutoInstanceID1   uint32 `json:"auto_instance_id_1" category:"tag" sub:"universal_tag"`
	AutoInstanceType1 uint8  `json:"auto_instance_type_1" category:"tag" sub:"universal_tag"`
	AutoServiceID1    uint32 `json:"auto_service_id_1" category:"tag" sub:"universal_tag"`
	AutoServiceType1  uint8  `json:"auto_service_type_1" category:"tag" sub:"universal_tag"`
...
type FlowInfo struct {
	CloseType    uint16   `json:"close_type" category:"tag" sub:"flow_info" translate:"close_type"`
	SignalSource uint16   `json:"signal_source" category:"tag" sub:"capture_info" translate:"l4_signal_source"`
	...
	NatSource    uint8    `json:"nat_source" category:"tag" sub:"capture_info" translate:"nat_source"`
	TapPortType  uint8    `json:"capture_nic_type" category:"tag" sub:"capture_info" translate:"capture_nic_type"` // 0: MAC, 1: IPv4, 2:IPv6, 3: ID
	TapPort      uint32   `json:"capture_nic" category:"tag" sub:"capture_info"`
	TapSide      string   `json:"observation_point" category:"tag" sub:"capture_info" translate:"observation_point"`
	...
	Status       uint8    `json:"status" category:"tag" sub:"flow_info" translate:"status"`
