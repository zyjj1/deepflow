...
type AppTraffic struct {
	Request        uint32 `json:"request" category:"metrics"`
	Response       uint32 `json:"response" category:"metrics"`
...
type AppAnomaly struct {
	ClientError uint32 `json:"client_error" category:"metrics"`
	ServerError uint32 `json:"server_error" category:"metrics"`
	Timeout     uint32 `json:"timeout" category:"metrics"`
}
