...
type Field struct {
	...
	Protocol   layers.IPProtocol `json:"protocol" category:"tag" sub:"network_layer" translate:"protocol"`
	...
	TAPSide      TAPSideEnum      `json:"observation_point" category:"tag" sub:"capture_info" translate:"observation_point" datasource:"nm|am"`
	TAPType      TAPTypeEnum      `json:"capture_nic_type" category:"tag" sub:"capture_info" translate:"capture_nic_type"`
	IsIPv4       uint8            `json:"is_ipv4" category:"tag" sub:"network_layer"` // (8B) 与IP/IP6是共生字段
	IsKeyService uint8
	L7Protocol   datatype.L7Protocol `json:"l7_protocol" category:"tag" sub:"application_layer" translate:"l7_protocol" datasource:"a|am"`
	...
	SignalSource uint16              `json:"signal_source" category:"tag" sub:"application_layer" translate:"l7_signal_source"` // FIXME: network,network_1m should use l4_signal_source for translate
