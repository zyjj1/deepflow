...
func (d *DocumentFlow) GetFieldValueByOffsetAndKind(offset uintptr, kind reflect.Kind, fieldName string) interface{} {
	return utils.GetValueByOffsetAndKind(uintptr(unsafe.Pointer(d)), offset, kind, fieldName)
}
...
func (d *DocumentApp) GetFieldValueByOffsetAndKind(offset uintptr, kind reflect.Kind, fieldName string) interface{} {
	return utils.GetValueByOffsetAndKind(uintptr(unsafe.Pointer(d)), offset, kind, fieldName)
}
...
func (d *DocumentUsage) GetFieldValueByOffsetAndKind(offset uintptr, kind reflect.Kind, fieldName string) interface{} {
	return utils.GetValueByOffsetAndKind(uintptr(unsafe.Pointer(d)), offset, kind, fieldName)
}
